<span style="font-size: 12px;"><span style="font-size: 14px;">
		<%@ page language="java"
			import="java.sql.*,java.io.*,java.util.*, com.mystruts.acion.AuthorAction,com.opensymphony.xwork2.ActionContext"%>
...
<body>
	...
	<%  
        ...
        //联结字符串   
        String url = "jdbc:mysql://rrpmsushspsg.rds.sae.sina.com.cn:10083/" + dbName + "?user="  
                + userName + "&password=" + userPasswd;  
        Class.forName("com.mysql.jdbc.Driver").newInstance();  
        Connection connection = DriverManager.getConnection(url);  
        Statement statement = connection.createStatement();  
        AuthorAction a = new AuthorAction();
        String temp;
		temp = ActionContext.getContext().get("ID").toString();
        System.out.println(temp);
        String sql = "SELECT * FROM Book where AuthorID="+ temp;
	...
	<table align="center">
		...
		<tr>
			...
			<td><a
				href="<%=request.getContextPath()%>/passISBN.action?ISBN=<%=rs.getString(1)%>">修改信息</a>
				<a
